...
mas que só permite realizar a compra, se a pessoa tiver dinheiro para pagar à vista e 
se estiver com a anuidade de associação de produtor rural em dia. 
'''
...
anuidade = str(input("Sua anuidade de produtor está em dia?(Sim,Não)\n"));
...
if(anuidade == "Sim"):
    ...
    print("Sua anuidade não está em dia, não é possivel prosseguir com a compra");